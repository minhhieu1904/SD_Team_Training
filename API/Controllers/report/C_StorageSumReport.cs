...
namespace API.Controllers.report
{
    ...
    {
        private I_StorageSumReport _services;
        private readonly IWebHostEnvironment _webHostEnvironment; 
        public C_StorageSumReport ( I_StorageSumReport services,IWebHostEnvironment webHostEnvironment )
        {
            _services = services;
            _webHostEnvironment = webHostEnvironment;
        }
        [HttpGet("getData")]
        public async Task<IActionResult> GetData([FromQuery]PaginationParam pagination ,[FromQuery] StorageSumReport param,bool isPaging = true)
        {
        ...
        [HttpGet("ExportExcel")]
        public async Task<IActionResult> ExportExcel([FromQuery]PaginationParam pagination ,[FromQuery] StorageSumReport param)
        {
            ...
            if(data.Result.Count > 0){
                ...
                "Resources\\Template\\StorageSumReport\\StoreSumReport.xlsx");
