...
import { SearchForOrderDataService } from './../../../../_core/services/search-for-order-data.service';
...
export class MainComponent extends InjectBase implements OnInit {
  @ViewChild(QrcodePrinterComponent) qrcodeprinter: QrcodePrinterComponent;
  ...
  constructor(private searchForOrderDataService: SearchForOrderDataService) {
    super();
  }
