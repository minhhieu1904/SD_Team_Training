...
import { MsQrOrder, SortSumReportParam, SortSumReportDTO, BrandDTO, SortSumDetailReportParam} from '@models/report/msQrOrder'; 
...
export class MainComponent implements OnInit {
  ...
  constructor(
    ...
    private route: ActivatedRoute
      ...
      const res: PaginationResult<MsQrOrder> = this.route.snapshot.data['res'];
